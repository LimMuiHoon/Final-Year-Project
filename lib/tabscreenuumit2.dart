...
class TabScreenUUMIT2 extends StatefulWidget {
  final UUMIT uumit;

  TabScreenUUMIT2({Key key, this.uumit});

  @override
  _TabScreenUUMIT2State createState() => _TabScreenUUMIT2State();
}

class _TabScreenUUMIT2State extends State<TabScreenUUMIT2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssueStaff =
        "http://limmuihoon.com/trackingsoc/php/load_issue_uumitt.php";
