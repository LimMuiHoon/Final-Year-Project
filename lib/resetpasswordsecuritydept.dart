...
String urlReset =
    "http://limmuihoon.com/trackingsoc/php/reset_passwordsecuritydept.php";

class ResetPasswordSecurityDeptScreen extends StatefulWidget {
  final String email;
  ResetPasswordSecurityDeptScreen({Key key, this.email}) : super(key: key);

  @override
  _ResetPasswordSecurityDeptScreenState createState() =>
      _ResetPasswordSecurityDeptScreenState();
}

class _ResetPasswordSecurityDeptScreenState
    extends State<ResetPasswordSecurityDeptScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Text("Reset your new password here, Please enter your new password!",
