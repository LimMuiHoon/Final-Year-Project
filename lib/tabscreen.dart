...
class _TabScreenState extends State<TabScreen> {
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          ...
                          style: TextStyle(
                              ...
                              color: Colors.red)),
                      /*Text(
                                                          "If you want delete the issue please click on the picture!"),*/
                    ],
                  ),
                );
              }
  ...
  Future<String> makeRequest() async {
    ...
    http.post(urlLoadIssue, body: {
      ...
      "position": widget.staff.position ?? "notavail",
    }).then((res) {
      setState(() {
  ...
  void _onIssueDetail(
    ...
    Navigator.push(context,
        SlideRightRoute(page: IssueDetail(issue: issue, staff: widget.staff)));
  }
