...
String urlReset = "http://limmuihoon.com/trackingsoc/php/reset_passwordjpp.php";

class ResetPasswordJPPScreen extends StatefulWidget {
  final String email;
  ResetPasswordJPPScreen({Key key, this.email}) : super(key: key);

  @override
  _ResetPasswordJPPScreenState createState() => _ResetPasswordJPPScreenState();
}

class _ResetPasswordJPPScreenState extends State<ResetPasswordJPPScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<bool> _onBackPressAppBar() async {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => ForgotPasswordJPPScreen(),
        ));
