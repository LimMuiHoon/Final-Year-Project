...
String urluploadImage =
    "http://limmuihoon.com/trackingsoc/php/upload_imageprofilepusatunitictsoc.php";
String urlupdate =
    "http://limmuihoon.com/trackingsoc/php/update_profilepusatunitictsoc.php";
File _image;
int number = 0;
String _value;

class TabScreenPusatUnitICTSOC3 extends StatefulWidget {
  //final String email;
  final PusatUnitICTSOC pusatunitictsoc;
  TabScreenPusatUnitICTSOC3({this.pusatunitictsoc});

  @override
  _TabScreenPusatUnitICTSOC3State createState() =>
      _TabScreenPusatUnitICTSOC3State();
}

class _TabScreenPusatUnitICTSOC3State extends State<TabScreenPusatUnitICTSOC3> {
                                      ...
                                      decoration: new BoxDecoration(
                                          ...
                                          image: new DecorationImage(
                                              ...
                                              image: new NetworkImage(
                                                  "http://limmuihoon.com/trackingsoc/profile/${widget.pusatunitictsoc.email}.jpg?dummy=${(number)}'")))),
                                ),
                                SizedBox(height: 50),
                                /*Container(
                                  child: Text(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(widget.pusatunitictsoc.phone ??
                                            'not registered'),
                                      ],
                                    ),
                                  ],
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(widget.pusatunitictsoc.position ??
                                            'not registered'),
                                      ],
                                    ),
                                  ],
  ...
  void _changeName() {
    ...
    if (widget.pusatunitictsoc.name == "not register") {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title:
              new Text("Change name for " + widget.pusatunitictsoc.name + "?"),
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  "email": widget.pusatunitictsoc.email,
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.pusatunitictsoc.name = dres[1];
                    });
  ...
  void _changePassword() {
    ...
    // flutter defined function
    print(widget.pusatunitictsoc.name);
    if (widget.pusatunitictsoc.name == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change Password for " + widget.pusatunitictsoc.name),
          content: new TextField(
  ...
  void _changePhone() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change phone for" + widget.pusatunitictsoc.name),
          content: new TextField(
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    setState(() {
                      widget.pusatunitictsoc.phone = dres[3];
                      Toast.show("Success ", context,
                          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                      Navigator.of(context).pop();
                      return;
  ...
  /*void _gotologinPage() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Go to login page?" + widget.pusatunitictsoc.name),
          content: new Text("Are your sure?"),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
  ...
  void _changePosition() {
    ...
    if (widget.pusatunitictsoc.position == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text(
              "Change position for " + widget.pusatunitictsoc.position + "?"),
          content: new TextField(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.pusatunitictsoc.position = dres[4];
                    });
                    Toast.show("Success", context,
                        duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                    Navigator.of(context).pop();
