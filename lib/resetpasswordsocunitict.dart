...
String urlReset =
    "http://limmuihoon.com/trackingsoc/php/reset_passwordsocunitict.php";

class ResetPasswordSOCICTUnitScreen extends StatefulWidget {
  final String email;
  ResetPasswordSOCICTUnitScreen({Key key, this.email}) : super(key: key);

  @override
  _ResetPasswordSOCICTUnitScreenState createState() =>
      _ResetPasswordSOCICTUnitScreenState();
}

class _ResetPasswordSOCICTUnitScreenState
    extends State<ResetPasswordSOCICTUnitScreen> {
  @override
  void initState() {
    super.initState();
  }
