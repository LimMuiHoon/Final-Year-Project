...
import 'package:tracking_soc/issuedetailjpp.dart';
import 'dart:convert';
...
class TabScreenJPP extends StatefulWidget {
  final JPP jpp;
  ...
  @override
  _TabScreenJPPState createState() => _TabScreenJPPState();
}

class _TabScreenJPPState extends State<TabScreenJPP> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssue =
        "https://limmuihoon.com/trackingsoc/php/load_issuejpp.php";
  ...
  void _onIssueDetail(
    ...
    Navigator.push(context,
        SlideRightRoute(page: IssueDetailJpp(issue: issue, jpp: widget.jpp)));
  }
