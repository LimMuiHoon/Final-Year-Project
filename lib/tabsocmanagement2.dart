...
import 'package:tracking_soc/newissuesoc.dart';
...
class TabSocManagement2 extends StatefulWidget {
  final SocManagement socmanagement;

  TabSocManagement2({Key key, this.socmanagement});

  @override
  _TabSocManagement2State createState() => _TabSocManagement2State();
}

class _TabSocManagement2State extends State<TabSocManagement2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssueStaff =
        "http://limmuihoon.com/trackingsoc/php/load_issuesocmgt.php";
  ...
  void requestNewIssue() {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (BuildContext context) => NewIssueSoc(
