...
import 'package:tracking_soc/resetpasswordscreen.dart';
import 'dart:async';
import 'package:progress_dialog/progress_dialog.dart';
import 'package:toast/toast.dart';
import 'package:http/http.dart' as http;

String urlForgot = "https://limmuihoon.com/trackingsoc/php/forgot_password.php";
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text('Forgot Password Staff')),
