...
class TabScreenPusatUnitICTSOC2 extends StatefulWidget {
  final PusatUnitICTSOC pusatunitictsoc;

  TabScreenPusatUnitICTSOC2({Key key, this.pusatunitictsoc});

  @override
  _TabScreenPusatUnitICTSOC2State createState() =>
      _TabScreenPusatUnitICTSOC2State();
}

class _TabScreenPusatUnitICTSOC2State extends State<TabScreenPusatUnitICTSOC2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssueStaff =
        "http://limmuihoon.com/trackingsoc/php/load_issue_pusatunitictsocc.php";
