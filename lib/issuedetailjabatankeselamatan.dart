...
String urldelete =
    "http://limmuihoon.com/trackingsoc/php/delete_issuesecuritydept.php";

class IssueDetailJabatanKeselamatan extends StatefulWidget {
  final Issue issue;
  final Staff staff;
  final SocManagement socmanagement;
  final JPP jpp;
  final JabatanKeselamatan jabatankeselamatan;
  const IssueDetailJabatanKeselamatan({
    Key key,
    this.issue,
    this.staff,
    this.socmanagement,
  ...
  @override
  _IssueDetailJabatanKeselamatanState createState() =>
      _IssueDetailJabatanKeselamatanState();
}

class _IssueDetailJabatanKeselamatanState
    extends State<IssueDetailJabatanKeselamatan> {
  @override
