...
String urluploadImage =
    "https://limmuihoon.com/trackingsoc/php/upload_imageprofilejpp.php";
String urlupdate =
    "https://limmuihoon.com/trackingsoc/php/update_profilejpp.php";
File _image;
int number = 0;
String _value;

class TabScreenJPP3 extends StatefulWidget {
  //final String email;
  final JPP jpp;
  TabScreenJPP3({this.jpp});

  @override
  _TabScreenJPP3State createState() => _TabScreenJPP3State();
}

class _TabScreenJPP3State extends State<TabScreenJPP3> {
                                      ...
                                      decoration: new BoxDecoration(
                                          ...
                                          image: new DecorationImage(
                                              ...
                                              image: new NetworkImage(
                                                  "http://limmuihoon.com/trackingsoc/profile/${widget.jpp.email}.jpg?dummy=${(number)}'")))),
                                ),
                                SizedBox(height: 50),
                                /*Container(
                                  child: Text(
  ...
  void _changeName() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Change name for " + widget.jpp.name + "?"),
  ...
  void _changePassword() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change Password for " + widget.jpp.name),
          content: new TextField(
  ...
  void _changePhone() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change phone for" + widget.jpp.name),
          content: new TextField(
  ...
  /* void _gotologinPage() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Go to login page?" + widget.jpp.name),
          content: new Text("Are your sure?"),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
  ...
  void _changePosition() {
    ...
    if (widget.jpp.position == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change position for " + widget.jpp.position + "?"),
          content: new TextField(
