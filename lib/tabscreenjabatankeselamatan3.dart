...
String urluploadImage =
    "http://limmuihoon.com/trackingsoc/php/upload_imageprofilejabatankeselamatan.php";
String urlupdate =
    "http://limmuihoon.com/trackingsoc/php/update_profilejabatankeselamatan.php";
File _image;
int number = 0;
String _value;

class TabScreenJabatanKeselamatan3 extends StatefulWidget {
  //final String email;
  final JabatanKeselamatan jabatankeselamatan;
  TabScreenJabatanKeselamatan3({this.jabatankeselamatan});

  @override
  _TabScreenJabatanKeselamatan3State createState() =>
      _TabScreenJabatanKeselamatan3State();
}

class _TabScreenJabatanKeselamatan3State
    extends State<TabScreenJabatanKeselamatan3> {
                          ...
                          Stack(children: <Widget>[
                            ...
                            Column(
                              children: <Widget>[
                                      ...
                                      decoration: new BoxDecoration(
                                          ...
                                          image: new DecorationImage(
                                              ...
                                              image: new NetworkImage(
                                                  "http://limmuihoon.com/trackingsoc/profile/${widget.jabatankeselamatan.email}.jpg?dummy=${(number)}'")))),
                                ),
                                SizedBox(height: 50),
                                /*Container(
                                  child: Text(
                                    widget.jabatankeselamatan.name
                                            ?.toUpperCase() ??
                                        'Not register',
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                ...
                                Container(
                                  child: Text(
                                    widget.jabatankeselamatan.email,
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 14),
                                  ),
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(widget.jabatankeselamatan.phone ??
                                            'not registered'),
                                      ],
                                    ),
                                  ],
  ...
  void _changeName() {
    ...
    if (widget.jabatankeselamatan.name == "not register") {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text(
              "Change name for " + widget.jabatankeselamatan.name + "?"),
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  "email": widget.jabatankeselamatan.email,
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.jabatankeselamatan.name = dres[1];
                    });
  ...
  void _changePassword() {
    ...
    // flutter defined function
    print(widget.jabatankeselamatan.name);
    if (widget.jabatankeselamatan.name == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title:
              new Text("Change Password for " + widget.jabatankeselamatan.name),
          content: new TextField(
  ...
  void _changePhone() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change phone for" + widget.jabatankeselamatan.name),
          content: new TextField(
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    setState(() {
                      widget.jabatankeselamatan.phone = dres[3];
                      Toast.show("Success ", context,
                          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                      Navigator.of(context).pop();
                      return;
  ...
  /*void _gotologinPage() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Go to login page?" + widget.jabatankeselamatan.name),
          content: new Text("Are your sure?"),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
  ...
  void _changePosition() {
    ...
    if (widget.jabatankeselamatan.position == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change position for " +
              widget.jabatankeselamatan.position +
              "?"),
          content: new TextField(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.jabatankeselamatan.position = dres[4];
                    });
                    Toast.show("Success", context,
                        duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                    Navigator.of(context).pop();
