...
class TabScreenJabatanKeselamatan2 extends StatefulWidget {
  final JabatanKeselamatan jabatankeselamatan;

  TabScreenJabatanKeselamatan2({Key key, this.jabatankeselamatan});

  @override
  _TabScreenJabatanKeselamatan2State createState() =>
      _TabScreenJabatanKeselamatan2State();
}

class _TabScreenJabatanKeselamatan2State
    extends State<TabScreenJabatanKeselamatan2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssueStaff =
        "http://limmuihoon.com/trackingsoc/php/load_issuejabatankeselamatann.php";
