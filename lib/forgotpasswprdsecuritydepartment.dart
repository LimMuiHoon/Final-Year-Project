...
import 'package:tracking_soc/resetpasswordsecuritydept.dart';
import 'dart:async';
...
String urlForgot =
    "http://limmuihoon.com/trackingsoc/php/forgot_passwordsecuritydept.php";

class ForgotPasswordSecurityDeptScreen extends StatefulWidget {
  final String email;

  @override
  _ForgotPasswordSecurityDeptScreenState createState() =>
      _ForgotPasswordSecurityDeptScreenState();
  const ForgotPasswordSecurityDeptScreen({Key key, this.email})
      : super(key: key);
}

class _ForgotPasswordSecurityDeptScreenState
    extends State<ForgotPasswordSecurityDeptScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text('Forgot Password Security Department')),
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (BuildContext context) =>
                      ResetPasswordSecurityDeptScreen(email: _email)));
        } else {
          pr.dismiss();
        }
      }).catchError((err) {
