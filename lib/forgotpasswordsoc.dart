...
import 'package:tracking_soc/resetpasswordsoc.dart';
import 'dart:async';
...
String urlForgot =
    "http://limmuihoon.com/trackingsoc/php/forgot_passwordsoc.php";

class ForgotPasswordSOCScreen extends StatefulWidget {
  final String email;

  @override
  _ForgotPasswordSOCScreenState createState() =>
      _ForgotPasswordSOCScreenState();
  const ForgotPasswordSOCScreen({Key key, this.email}) : super(key: key);
}

class _ForgotPasswordSOCScreenState extends State<ForgotPasswordSOCScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text('Forgot Password SOC Management')),
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (BuildContext context) =>
                      ResetPasswordSOCScreen(email: _email)));
        } else {
          pr.dismiss();
        }
      }).catchError((err) {
