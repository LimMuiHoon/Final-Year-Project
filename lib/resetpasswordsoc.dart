...
String urlReset = "http://limmuihoon.com/trackingsoc/php/reset_passwordsoc.php";

class ResetPasswordSOCScreen extends StatefulWidget {
  final String email;
  ResetPasswordSOCScreen({Key key, this.email}) : super(key: key);

  @override
  _ResetPasswordSOCScreenState createState() => _ResetPasswordSOCScreenState();
}

class _ResetPasswordSOCScreenState extends State<ResetPasswordSOCScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<bool> _onBackPressAppBar() async {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => ForgotPasswordSOCScreen(),
        ));
