...
import 'package:tracking_soc/issuedetailuumit.dart';
import 'dart:convert';
...
class TabScreenUUMIT extends StatefulWidget {
  final UUMIT uumit;
  ...
  @override
  _TabScreenUUMITState createState() => _TabScreenUUMITState();
}

class _TabScreenUUMITState extends State<TabScreenUUMIT> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssue =
        "http://limmuihoon.com/trackingsoc/php/load_issue_uumit.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
    pr.style(message: "Loading Your Report Issue");
    pr.show();
    http.post(urlLoadIssue, body: {
      "email": widget.uumit.email ?? "notavail",
      "position": widget.uumit.position ?? "notavail",
    }).then((res) {
      setState(() {
  ...
  void _onIssueDetail(
    ...
    Navigator.push(
        context,
        SlideRightRoute(
            page: IssueDetailUUMIT(issue: issue, uumit: widget.uumit)));
  }
