...
String urldelete =
    "http://limmuihoon.com/trackingsoc/php/delete_issueuumit.php";

class IssueDetailUUMIT extends StatefulWidget {
  final Issue issue;
  final Staff staff;
  ...
  @override
  _IssueDetailUUMITState createState() => _IssueDetailUUMITState();
}

class _IssueDetailUUMITState extends State<IssueDetailUUMIT> {
  @override
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: MaterialButton(
                  ...
                  height: 40,
                  child: Text(
                    'Update Issue Issue Task Comment',
                    style: TextStyle(fontSize: 16),
                  ),
                  color: Colors.blueAccent,
                  textColor: Colors.white,
