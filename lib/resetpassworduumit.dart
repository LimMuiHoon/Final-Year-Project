...
String urlReset =
    "http://limmuihoon.com/trackingsoc/php/reset_passworduumit.php";

class ResetPasswordUUMITScreen extends StatefulWidget {
  final String email;
  ResetPasswordUUMITScreen({Key key, this.email}) : super(key: key);

  @override
  _ResetPasswordUUMITScreenState createState() =>
      _ResetPasswordUUMITScreenState();
}

class _ResetPasswordUUMITScreenState extends State<ResetPasswordUUMITScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<bool> _onBackPressAppBar() async {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => ForgotPasswordUUMITScreen(),
        ));
