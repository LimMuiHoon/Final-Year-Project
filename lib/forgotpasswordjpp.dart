...
import 'package:tracking_soc/resetpasswordjpp.dart';
import 'dart:async';
...
String urlForgot =
    "http://limmuihoon.com/trackingsoc/php/forgot_passwordjpp.php";

class ForgotPasswordJPPScreen extends StatefulWidget {
  final String email;

  @override
  _ForgotPasswordJPPScreenState createState() =>
      _ForgotPasswordJPPScreenState();
  const ForgotPasswordJPPScreen({Key key, this.email}) : super(key: key);
}

class _ForgotPasswordJPPScreenState extends State<ForgotPasswordJPPScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text('Forgot Password JPP')),
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (BuildContext context) =>
                      ResetPasswordJPPScreen(email: _email)));
        } else {
          pr.dismiss();
        }
      }).catchError((err) {
