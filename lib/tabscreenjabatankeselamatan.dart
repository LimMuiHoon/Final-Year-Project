...
import 'package:tracking_soc/issuedetailjabatankeselamatan.dart';
import 'dart:convert';
...
class TabScreenJabatanKeselamatan extends StatefulWidget {
  ...
  @override
  _TabScreenJabatanKeselamatanState createState() =>
      _TabScreenJabatanKeselamatanState();
}

class _TabScreenJabatanKeselamatanState
    extends State<TabScreenJabatanKeselamatan> {
  ...
  Future<String> makeRequest() async {
    String urlLoadIssue =
        "http://limmuihoon.com/trackingsoc/php/load_issue_jabatankeselamatan.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
    pr.style(message: "Loading Your Report Issue");
    pr.show();
    http.post(urlLoadIssue, body: {
      "email": widget.jabatankeselamatan.email ?? "notavail",
      "position": widget.jabatankeselamatan.position ?? "notavail",
    }).then((res) {
      setState(() {
  ...
  void _onIssueDetail(
    ...
    Navigator.push(
        context,
        SlideRightRoute(
            page: IssueDetailJabatanKeselamatan(
                issue: issue, jabatankeselamatan: widget.jabatankeselamatan)));
  }
