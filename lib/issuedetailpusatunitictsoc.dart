...
String urlupdate =
    "http://limmuihoon.com/trackingsoc/php/update_issue_statusict.php";
String urlupdatecomment =
    "http://limmuihoon.com/trackingsoc/php/update_issue_task_commentict.php";
String urldelete =
    "http://limmuihoon.com/trackingsoc/php/delete_issuesocictunit.php";

class IssueDetailPusatUnitIctSOC extends StatefulWidget {
  final Issue issue;
  final Staff staff;
  ...
  const IssueDetailPusatUnitIctSOC({
    Key key,
    this.issue,
    this.staff,
    this.socmanagement,
  ...
  @override
  _IssueDetailPusatUnitIctSOCState createState() =>
      _IssueDetailPusatUnitIctSOCState();
}

class _IssueDetailPusatUnitIctSOCState
    extends State<IssueDetailPusatUnitIctSOC> {
  @override
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.issue.issuestatus = dres[12];
                      if (dres[0] == "success") {
                        print("in setstate");
                        widget.issue.issuestatus = dres[12];
                      }
