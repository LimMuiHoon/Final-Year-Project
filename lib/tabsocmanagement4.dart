...
String urluploadImage =
    "https://limmuihoon.com/trackingsoc/php/upload_imageprofilesoc.php";
String urlupdate =
    "https://limmuihoon.com/trackingsoc/php/update_profilesoc.php";
File _image;
int number = 0;
String _value;

class TabSocManagement4 extends StatefulWidget {
  //final String email;
  final SocManagement socmanagement;
  TabSocManagement4({this.socmanagement});

  @override
  _TabSocManagement4State createState() => _TabSocManagement4State();
}

class _TabSocManagement4State extends State<TabSocManagement4> {
                                      ...
                                      decoration: new BoxDecoration(
                                          ...
                                          image: new DecorationImage(
                                              ...
                                              image: new NetworkImage(
                                                  "http://limmuihoon.com/trackingsoc/profile/${widget.socmanagement.email}.jpg?dummy=${(number)}'")))),
                                ),
                                SizedBox(height: 50),
                                /*Container(
                                  child: Text(
                                    widget.socmanagement.name?.toUpperCase() ??
                                        'Not register',
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 16),
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(widget.socmanagement.phone ??
                                            'not registered'),
                                      ],
                                    ),
                                  ],
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(widget.socmanagement.position ??
                                            'not registered'),
                                      ],
                                    ),
                                  ],
  ...
  void _changeName() {
    ...
    if (widget.socmanagement.name == "not register") {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Change name for " + widget.socmanagement.name + "?"),
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.socmanagement.name = dres[1];
                    });
  ...
  void _changePassword() {
    ...
    // flutter defined function
    print(widget.socmanagement.name);
    if (widget.socmanagement.name == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change Password for " + widget.socmanagement.name),
          content: new TextField(
  ...
  void _changePhone() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change phone for" + widget.socmanagement.name),
          content: new TextField(
            ...
            new FlatButton(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    setState(() {
                      widget.socmanagement.phone = dres[3];
                      Toast.show("Success ", context,
                          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                      Navigator.of(context).pop();
                      return;
  ...
  /*void _gotologinPage() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Go to login page?" + widget.socmanagement.name),
          content: new Text("Are your sure?"),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
  ...
  void _changePosition() {
    ...
    if (widget.socmanagement.position == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text(
              "Change position for " + widget.socmanagement.position + "?"),
          content: new TextField(
              ...
              onPressed: () {
                ...
                http.post(urlupdate, body: {
                  ...
                  if (dres[0] == "success") {
                    print('in success');
                    setState(() {
                      widget.socmanagement.position = dres[4];
                    });
                    Toast.show("Success", context,
                        duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                    Navigator.of(context).pop();
