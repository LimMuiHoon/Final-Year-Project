...
import 'package:tracking_soc/resetpassworduumit.dart';
import 'dart:async';
...
String urlForgot =
    "http://limmuihoon.com/trackingsoc/php/forgot_passworduumit.php";

class ForgotPasswordUUMITScreen extends StatefulWidget {
  final String email;

  @override
  _ForgotPasswordUUMITScreenState createState() =>
      _ForgotPasswordUUMITScreenState();
  const ForgotPasswordUUMITScreen({Key key, this.email}) : super(key: key);
}

class _ForgotPasswordUUMITScreenState extends State<ForgotPasswordUUMITScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(title: Text('Forgot Password UUMIT')),
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (BuildContext context) =>
                      ResetPasswordUUMITScreen(email: _email)));
        } else {
          pr.dismiss();
        }
      }).catchError((err) {
