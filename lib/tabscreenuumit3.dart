...
String urlgetuser = "http://limmuihoon.com/trackingsoc/php/get_staffuumit.php";
String urluploadImage =
    "http://limmuihoon.com/trackingsoc/php/upload_imageprofileuumit.php";
String urlupdate =
    "http://limmuihoon.com/trackingsoc/php/update_profileuumit.php";
File _image;
int number = 0;
String _value;

class TabScreenUUMIT3 extends StatefulWidget {
  //final String email;
  final UUMIT uumit;
  TabScreenUUMIT3({this.uumit});

  @override
  _TabScreenUUMIT3State createState() => _TabScreenUUMIT3State();
}

class _TabScreenUUMIT3State extends State<TabScreenUUMIT3> {
                                      ...
                                      decoration: new BoxDecoration(
                                          ...
                                          image: new DecorationImage(
                                              ...
                                              image: new NetworkImage(
                                                  "http://limmuihoon.com/trackingsoc/profile/${widget.uumit.email}.jpg?dummy=${(number)}'")))),
                                ),
                                SizedBox(height: 50),
                                /*Container(
                                  child: Text(
                                    widget.uumit.name?.toUpperCase() ??
                                        'Not register',
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 16),
  ...
  void _changeName() {
    ...
    if (widget.uumit.name == "not register") {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Change name for " + widget.uumit.name + "?"),
  ...
  void _changePassword() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change Password for " + widget.uumit.name),
          content: new TextField(
  ...
  void _changePhone() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change phone for" + widget.uumit.name),
          content: new TextField(
  ...
  /*void _gotologinPage() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Go to login page?" + widget.uumit.name),
          content: new Text("Are your sure?"),
          actions: <Widget>[
            // usually buttons at the bottom of the dialog
            new FlatButton(
  ...
  void _changePosition() {
    ...
    if (widget.uumit.position == "not register") {
      Toast.show("Not allowed", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        // return object of type Dialog
        return AlertDialog(
          title: new Text("Change position for " + widget.uumit.position + "?"),
          content: new TextField(
